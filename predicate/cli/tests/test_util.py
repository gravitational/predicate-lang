...
from ..util import create_dir_if_not_exist, create_policy_from_template, get_classname

TEST_DIR_PATH = "testpath"
TEST_POLICY = "devOps"

def test_create_dir_if_not_exist(tmp_path):
...
class Developer:
    ...
    class_name = get_classname(policy1)
